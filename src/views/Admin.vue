        ...
        async startElection() {
            try {
                if (this.election_name!='') {
                    let response = await this.contract_store.contract.startElection(this.election_name)
...
<template>
    <div class="Admin">
        <div class="welcome">
            <h1>WELCOME</h1>
            <span>
                Electronic voting in polling stations is in place in some of the world’s largest
